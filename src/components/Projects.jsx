...
export const Projects = () => {
    const [pernProject, setPernProject] = useState("https://joaopedro-javascript-space-invaders.netlify.app/")
    ...
    return (
        <section className="w-full flex flex-col justify-center items-center bg-blue-600 text-white py-4">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-5 lg:gap-24 justify-center items-center">
                {/* javascript games */}
                <div className=" w-full sm:w-3/4 max-w-[30rem] flex flex-col justify-center items-center p-2">
                ...
                <div className="w-full sm:w-3/4 max-w-[30rem] flex flex-col justify-center items-center p-2">
                    ...
                    <iframe title="javascript-games-iframe" className="w-full bg-white aspect-square rounded-lg" scrolling="no" src={d3Project} />
                </div>
            </div>
