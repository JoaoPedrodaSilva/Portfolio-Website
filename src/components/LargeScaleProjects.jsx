    ...
    <section className="flex justify-center items-center bg-blue-600 text-white py-6">
        ...
        <div className='h-full flex justify-center gap-10'>
            <iframe
                ...
                className="hidden lg:flex w-full max-w-[1024px] rounded-lg"
            ...
            <div className="w-full lg:w-1/4 h-full flex flex-col justify-between gap-6 text-justify px-8 lg:px-0">
                ...
                <p>I've built it using the PERN stack - Node.js and Express.js as backend, PostgreSQL as database, and React.js as frontend - I also used TailwindCss for styling and Charts.js for data visualization. </p>
